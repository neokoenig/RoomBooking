...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Create Workflow Table">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
				t = createTable(name='workflows', force='true', id='true', primaryKey='id');
				t.string(columnNames='title', null=false, limit='255');
				t.boolean(columnNames='isactive', default=false);
				t.timestamps();
				t.create();
	    	}
	    	catch (any ex){
