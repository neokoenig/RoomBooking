...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="CLI create_table_settings">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
				t = createTable(name='settings', force='true', id='true');
				t.string(columnNames="name,description", limit=255);
				t.string(columnNames="type", limit=50);
				t.string(columnNames="options,value,docs", limit=500);
				t.create();
