...
--->
<cfcomponent extends="wheels.dbmigrate.Migration" hint="Create UserPermission Table">
  <cffunction name="up">
  	...
  	<cftransaction>
	    <cfscript>
	    	try{
				...
				t = createTable(name='workflowtriggers', force='true', id='false');
				t.primaryKey(name="workflowid",limit=11);
				t.primaryKey(name="triggerid",limit=11);
				t.primaryKey(name="actionid",limit=11);
				t.create();
	    	}
	    	catch (any ex){
	    		hasError = true;
