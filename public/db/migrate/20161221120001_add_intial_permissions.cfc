...
--->
<cfcomponent extends="wheels.dbmigrate.Migration" hint="Add Default Permissions">
  <cffunction name="up">
	    ...
	    <cfscript>
			...
			addRecord(table='rolepermissions', roleid=3, permissionid=c);
				...
				addRecord(table='rolepermissions', roleid=3, permissionid=c);
					...
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
				c++;
				addRecord(table='permissions', name='public', description="Access the Main Application Front end");
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
				...
				c++;
				addRecord(table='permissions', name='public.bookings', description='Allow Booking Request Access');
				addRecord(table='rolepermissions', roleid=1, permissionid=c);
				addRecord(table='rolepermissions', roleid=2, permissionid=c);
				addRecord(table='rolepermissions', roleid=3, permissionid=c);
				addRecord(table='rolepermissions', roleid=4, permissionid=c);
				...
				addRecord(table='rolepermissions', roleid=6, permissionid=c);
				c++;
				addRecord(table='permissions', name='public.bookings.new', description='New Booking Form');
				addRecord(table='rolepermissions', roleid=1, permissionid=c);
				addRecord(table='rolepermissions', roleid=2, permissionid=c);
				addRecord(table='rolepermissions', roleid=3, permissionid=c);
				addRecord(table='rolepermissions', roleid=4, permissionid=c);
				addRecord(table='rolepermissions', roleid=5, permissionid=c);
				c++;
				addRecord(table='permissions', name='public.bookings.create', description='Create a booking');
				addRecord(table='rolepermissions', roleid=1, permissionid=c);
				addRecord(table='rolepermissions', roleid=2, permissionid=c);
				addRecord(table='rolepermissions', roleid=3, permissionid=c);
				addRecord(table='rolepermissions', roleid=4, permissionid=c);
				...
				addRecord(table='rolepermissions', roleid=3, permissionid=c);
				c++;
				addRecord(table='permissions', name='public.my', description='Allow General Access to Own Profile/Booking Listings');
				addRecord(table='rolepermissions', roleid=1, permissionid=c);
				addRecord(table='rolepermissions', roleid=2, permissionid=c);
				addRecord(table='rolepermissions', roleid=3, permissionid=c);
				addRecord(table='rolepermissions', roleid=4, permissionid=c);
				addRecord(table='rolepermissions', roleid=5, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.my.account', description='View Own Account');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					addRecord(table='rolepermissions', roleid=5, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.my.accountupdate', description='Update Own Account');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					addRecord(table='rolepermissions', roleid=5, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.my.bookings', description='View Own Bookings');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					addRecord(table='rolepermissions', roleid=5, permissionid=c);
				c++;
				addRecord(table='permissions', name='public.calendar', description='Allow General Calendar Access');
				addRecord(table='rolepermissions', roleid=1, permissionid=c);
				addRecord(table='rolepermissions', roleid=2, permissionid=c);
				addRecord(table='rolepermissions', roleid=3, permissionid=c);
				addRecord(table='rolepermissions', roleid=4, permissionid=c);
				...
				addRecord(table='rolepermissions', roleid=6, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.calendar.index', description='Allow User to view the Main Calendar');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					...
					addRecord(table='rolepermissions', roleid=6, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.calendar.show', description='Allow User to View Calendars');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					...
					addRecord(table='rolepermissions', roleid=6, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.calendar.fullcalendardata', description='Required for Full Calendar to get remote data');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					...
					addRecord(table='rolepermissions', roleid=6, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.calendar.fullcalendarfilters', description='Required for Full Calendar to get remote filters');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					...
					addRecord(table='rolepermissions', roleid=6, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.calendar.fullcalendarresources', description='Required for Full Calendar to get remote locations');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					...
					addRecord(table='rolepermissions', roleid=6, permissionid=c);
					c++;
					addRecord(table='permissions', name='public.calendar.yearcalendardata', description='Required for Year Calendar to get remote data');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
					...
					c++;
					addRecord(table='permissions', name='public.calendar.detail', description='View Booking Details in Calendar Sidepanel');
					addRecord(table='rolepermissions', roleid=1, permissionid=c);
					addRecord(table='rolepermissions', roleid=2, permissionid=c);
					addRecord(table='rolepermissions', roleid=3, permissionid=c);
					addRecord(table='rolepermissions', roleid=4, permissionid=c);
