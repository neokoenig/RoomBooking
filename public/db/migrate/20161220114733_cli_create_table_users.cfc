	    ...
	    <cfscript>
	    	try{
				...
				t.string(
					...
					default='', null=false, limit='50');
				t.string(
					columnNames='email',
					default='', null=false, limit='255');
				t.string(
					columnNames='address1,address2,city,county,country,tel,www,password,passwordresettoken,apikey',
					default='', null=true, limit='255');
				t.string(
					columnNames='title,postcode,locale,timezone',
