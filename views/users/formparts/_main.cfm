...
#panel(title="Main Account Details")# 
			<div class="row">
			<div class="col-lg-6">
				#textField(objectname="user", property="firstname", label="First Name", required="true",placeholder="i.e Joe")#
				#textField(objectname="user", property="lastname", label="Last Name", required="true",placeholder="i.e Bloggs")#  
				#textField(objectname="user", property="email", label="Email",  required="true",placeholder="joe@bloggs.com")#
