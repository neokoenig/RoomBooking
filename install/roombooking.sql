...
CREATE TABLE `events` (
  ...
  `className` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `layoutstyle` varchar(255) CHARACTER SET latin1 DEFAULT 'Standard',
...
CREATE TABLE `locations` (
  ...
  `class` varchar(55) CHARACTER SET latin1 NOT NULL,
  `colour` varchar(7) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `settings` VALUES ('calendarSlotMinutes', '00:15:00', 'Calendar No of minutes per slot (format HH:MM:SS)', 'string', '1', 'Calendar');
