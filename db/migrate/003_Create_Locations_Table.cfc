...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Create Locations Table">
  <cffunction name="up">
    <cfscript>
      t = createTable(name='locations');
      t.string(columnNames='name', default='', null=false, limit='255');
      t.string(columnNames='description', default='', null=true, limit='500');
      t.string(columnNames='class', default='', null=false, limit='55');
      t.string(columnNames='colour', default='', null=true, limit='7');
      t.create();
    </cfscript>
  </cffunction>
