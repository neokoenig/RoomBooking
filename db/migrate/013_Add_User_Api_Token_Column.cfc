...
--->
<cfcomponent extends="plugins.dbmigrate.Migration" hint="Add User Api Token Column">
  <cffunction name="up">
    <cfscript>
	    addColumn(table='users', columnType='string', limit=255, columnName='apitoken', default='', null=true);
    </cfscript>
  </cffunction>
  <cffunction name="down">
    <cfscript>
		removeColumn(table='users',columnName='apitoken');
    </cfscript>
  </cffunction>
</cfcomponent>
